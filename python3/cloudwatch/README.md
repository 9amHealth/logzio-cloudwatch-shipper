...
| EXCLUDE                                    | A list of regular expressions, each matching log will be excluded and not forwared to logz.io. Formatted as JSON array of strings, eg. `["^(.*),'commit',0$", "^(.*),'SET autocommit=(0\|1)',0$"]`                                                                                                                                          |
